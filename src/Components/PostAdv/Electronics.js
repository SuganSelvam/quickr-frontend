...
function Electronics(props) {
    ...
    return (
        <div id="RegisterBox">
            <div id="Heading" className="text-info">Sell an Electronic Item</div>
            <div className="DisplayFlex">
                <div className="form-group FlexChild">
                    <label htmlFor="Brand">Brand</label>
                    <input type="text" placeholder="Enter Brand Of Your Item" className="form-control" id="Brand" onChange={e => setBrand(e.target.value.toLowerCase())}></input>
                </div>
                <div className="form-group FlexChild">
                    <label htmlFor="Model">Model</label>
                    <input type="text" placeholder="Enter Model Of Your Item" className="form-control" id="Model" onChange={e => setModel(e.target.value.toLowerCase()) }></input>
                </div >
            </div>
